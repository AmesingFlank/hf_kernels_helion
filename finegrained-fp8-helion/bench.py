...
REPO = Path("/home/dev/hf_kernels_helion/finegrained-fp8-helion/finegrained-fp8-helion/result")
...
def main():
    ...
    print("=== finegrained-fp8-helion blockwise fp8 GEMM vs torch bf16 (dequant) matmul ===")
    bk=128
    ...
    for name,(M,N,K) in cfgs.items():
        ...
        report(f"fp8_gemm[{name}]",(M,N,K),
               lambda: k.w8a8_block_fp8_matmul(A,B,sA,sB,bk),
